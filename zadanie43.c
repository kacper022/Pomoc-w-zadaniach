...
void dodajOpcje3(char napis[], int dlugosc){
    int y=186;
    int i=0;
...
char menu3(void){
    ...
    printf("%c\n",pg);
    dodajOpcje3("  PRZYKLAD PROGRAMU WYKORZYSTUJACEGO MENU  ", l);
    printf("\n");
    printf("%c",sl);
    ...
    dodajOpcje3("w - wypisanie najwarzniejszych zasad", l);
    printf("\n");
    dodajOpcje3("p - przyklad programu",l);
    printf("\n");
    dodajOpcje3("k - koniec pracy",l);
    /*******************************************/
